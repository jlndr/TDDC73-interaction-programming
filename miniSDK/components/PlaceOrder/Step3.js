	...
	return (
		<>
				...
				<View style={styles.stepFields}>
					<View style={styles.optionBox}>
						<View style={styles.optionWrap}>
							...
							<TouchableOpacity
								style={[styles.option, {backgroundColor: selected == 1 ? "#eb7e02" : "white"}]}
						...
						<View style={styles.optionWrap}>
							...
							<TouchableOpacity
								style={[styles.option, {backgroundColor: selected == 2 ? "#eb7e02" : "white"}]}
						...
						<View style={styles.optionWrap}>
							...
							<TouchableOpacity
								style={[styles.option, {backgroundColor: selected == 3 ? "#eb7e02" : "white"}]}
			...
			<View style={styles.buttons}>
				...
				{page != 4 && (
					<TouchableOpacity style={styles.nextBackButton} onPress={() => setPage(page + 1)}>
